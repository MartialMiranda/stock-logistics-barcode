...
class WizStockBarcodesRead(models.AbstractModel):
    ...
    # name = fields.Char(string="Name", default="Barcode Wizard", help="Default name for barcode wizard")  # Commented out - column removed from DB
    barcode = fields.Char()
    ...
    def _compute_action_ids(self):
        actions = self.env["stock.barcodes.action"].search([("name", "!=", False)])
